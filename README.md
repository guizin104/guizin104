...
<p align="center">
  <a href="https://github.com/guizin104">
    <img src="https://img.shields.io/badge/Alagoas%2C_Brasil-0f172a?style=flat-square&logo=google-maps&logoColor=red" alt="Localização"/>
  </a>
  <a href="https://github.com/guizin104">
    <img src="https://img.shields.io/badge/IFAL-Técnico_em_Informática-1e293b?style=flat-square&logo=academia&logoColor=38bdf8" alt="Formação"/>
  </a>
  <a href="https://github.com/guizin104">
    <img src="https://img.shields.io/badge/Foco-UI%2FUX_%26_Algoritmos-0f172a?style=flat-square&logo=react&logoColor=61DAFB" alt="Foco"/>
  </a>
</p>
...
Sou estudante do **Ensino Médio Técnico em Informática no IFAL** e atuo no desenvolvimento web com foco em **Front-end moderno** desde 2025. Combino a paixão por criar interfaces intuitivas, responsivas e visualmente atraentes com uma forte base analítica e lógica.
...
### ⚙️ Back-end, Algoritmos & Automação
...
| 🚀 **FitScore** | 📒 **Caderneta** | 🤖 **Automação OBR** |
| :--- | :--- | :--- |
| **Plataforma Fitness Moderna**<br>Aplicação web para monitoramento de rotinas de treinos, evolução física e performance com dashboards visuais interativos. | **Controle Comercial & Financeiro**<br>Sistema completo de gestão para registro de compras, controle de clientes, fluxo de caixa e relatórios financeiros. | **Navegação Autônoma de Robôs**<br>Algoritmos de controle em tempo real, calibração e leitura de sensores de luz/cor e ultrassônicos para desvio de obstáculos. |
| 🛠️ `React` `Tailwind` `JS` | 🛠️ `Next.js` `TypeScript` `Node` | 🛠️ `Python` `C++` `Robótica` |
...
<p align="center">
  ⭐️ <i>Obrigado por visitar meu perfil! Se gostar de algum projeto, não deixe de deixar uma estrela nos repositórios.</i>
</p>
</p>
